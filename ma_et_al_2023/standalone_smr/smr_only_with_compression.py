...
#################################################################################
"""
This is a flowsheet for co-generation of blue hydrogen and power using ATR and gas turbine combined cycle
"""
import xlsxwriter
import os
...
#M from idaes.core.util.misc import svg_tag
...
def set_blue_hydrogen_plant_inputs(m):
    ...
    m.fs.ng_preheat1.tube_inlet.mole_frac_comp[:,'CO'].fix(0.0)
    m.fs.ng_preheat1.tube_inlet.mole_frac_comp[:,'CO2'].fix(0.01)
    m.fs.ng_preheat1.tube_inlet.mole_frac_comp[:,'H2'].fix(0.0)
    m.fs.ng_preheat1.tube_inlet.mole_frac_comp[:,'H2O'].fix(0.0)
    m.fs.ng_preheat1.tube_inlet.mole_frac_comp[:,'N2'].fix(0.016)
    m.fs.ng_preheat1.tube_inlet.mole_frac_comp[:,'O2'].fix(0.0)
    ...
    m.fs.ng_preheat1.shell_inlet.mole_frac_comp[:,'CH4'].value = 0.0
    m.fs.ng_preheat1.shell_inlet.mole_frac_comp[:,'CO'].value = 0.0
    m.fs.ng_preheat1.shell_inlet.mole_frac_comp[:,'CO2'].value = 0.0704
    m.fs.ng_preheat1.shell_inlet.mole_frac_comp[:,'H2'].value = 0.0
    ...
    m.fs.ng_preheat2.shell_inlet.mole_frac_comp[:,'CH4'].value = 0.0
    m.fs.ng_preheat2.shell_inlet.mole_frac_comp[:,'CO'].value = 0.0
    m.fs.ng_preheat2.shell_inlet.mole_frac_comp[:,'CO2'].value = 0.0704
    m.fs.ng_preheat2.shell_inlet.mole_frac_comp[:,'H2'].value = 0.0
    ...
    m.fs.smr_tube_mix.steam_inlet_state[0].mole_frac_comp['CH4'].value = 0.0
    m.fs.smr_tube_mix.steam_inlet_state[0].mole_frac_comp['CO'].value = 0.0
    m.fs.smr_tube_mix.steam_inlet_state[0].mole_frac_comp['CO2'].value = 0.0
    m.fs.smr_tube_mix.steam_inlet_state[0].mole_frac_comp['H2'].value = 0.0
    m.fs.smr_tube_mix.steam_inlet_state[0].mole_frac_comp['H2O'].value = 1.0
    m.fs.smr_tube_mix.steam_inlet_state[0].mole_frac_comp['N2'].value = 0.0
    m.fs.smr_tube_mix.steam_inlet_state[0].mole_frac_comp['O2'].value = 0.0
    m.fs.smr_tube_mix.steam_inlet_state[0].mole_frac_comp['Ar'].value = 0.0
    ...
    m.fs.smr_shell_mix.fuel_inlet_state[0].mole_frac_comp['CO'].fix(0.0)
    m.fs.smr_shell_mix.fuel_inlet_state[0].mole_frac_comp['CO2'].fix(0.01)
    m.fs.smr_shell_mix.fuel_inlet_state[0].mole_frac_comp['H2'].fix(0.0)
    m.fs.smr_shell_mix.fuel_inlet_state[0].mole_frac_comp['H2O'].fix(0.0)
    m.fs.smr_shell_mix.fuel_inlet_state[0].mole_frac_comp['N2'].fix(0.016)
    m.fs.smr_shell_mix.fuel_inlet_state[0].mole_frac_comp['O2'].fix(0.0)
    m.fs.smr_shell_mix.fuel_inlet_state[0].mole_frac_comp['Ar'].fix(0.0)
    ...
    m.fs.smr_shell_mix.air_inlet_state[0].mole_frac_comp['CH4'].fix(0.0)
    m.fs.smr_shell_mix.air_inlet_state[0].mole_frac_comp['CO'].fix(0.0)
    m.fs.smr_shell_mix.air_inlet_state[0].mole_frac_comp['CO2'].fix(0.0003)
    m.fs.smr_shell_mix.air_inlet_state[0].mole_frac_comp['H2'].fix(0.0)
    ...
    m.fs.smr_shell_mix.air_inlet_state[0].flow_mol.value = 16600  # mol/s
    m.fs.smr_shell_mix.air_inlet_state[0].temperature.value = 999  # K
    m.fs.smr_shell_mix.air_inlet_state[0].pressure.value = 1.0229e5  # Pa,
    m.fs.smr_shell_mix.air_inlet_state[0].mole_frac_comp['CH4'].value = 0.0
    m.fs.smr_shell_mix.air_inlet_state[0].mole_frac_comp['CO'].value = 0.00001
    m.fs.smr_shell_mix.air_inlet_state[0].mole_frac_comp['CO2'].value = 0.0477
    m.fs.smr_shell_mix.air_inlet_state[0].mole_frac_comp['H2'].value = 0.00004
    m.fs.smr_shell_mix.air_inlet_state[0].mole_frac_comp['H2O'].value = 0.10877
    m.fs.smr_shell_mix.air_inlet_state[0].mole_frac_comp['N2'].value = 0.74109
    m.fs.smr_shell_mix.air_inlet_state[0].mole_frac_comp['O2'].value = 0.10239
    m.fs.smr_shell_mix.air_inlet_state[0].mole_frac_comp['Ar'].value = 0.0
    '''
    ...
    m.fs.smr_shell_mix.tailgas_inlet.mole_frac_comp[:,'H2O'].value = 0.0
    m.fs.smr_shell_mix.tailgas_inlet.mole_frac_comp[:,'N2'].value = 0.0217634
    m.fs.smr_shell_mix.tailgas_inlet.mole_frac_comp[:,'O2'].value = 0.0
...
def write_results_to_excel(m, file_name):
    workbook = xlsxwriter.Workbook(file_name)
    # overall results
    worksheet0 = workbook.add_worksheet('overall')
    row = 0
    worksheet0.write(row,0,'H2 production Rate (kg/hr)')
    worksheet0.write(row,1,pyo.value(m.fs.h2_separator.h2_outlet.flow_mol[0]*m.fs.h2_separator.h2_outlet_state[0].mw*3600))
    row += 1
    worksheet0.write(row,0,'Total Modeled Water Pump Work (MW)')
    worksheet0.write(row,1,pyo.value(m.fs.mp_pump.work_mechanical[0]+m.fs.lp_pump.work_mechanical[0]+m.fs.mp_booster_pump.work_mechanical[0])/1e6)
    row += 1
    worksheet0.write(row,0,'Total CO2 Compression Work (MW)')
    worksheet0.write(row,1,pyo.value(m.fs.total_co2_compression_work[0]/1e6))
    row += 1
    worksheet0.write(row,0,'Total H2 Compression Work (MW)')
    worksheet0.write(row,1,pyo.value(m.fs.h2_comp.work_mechanical[0]/1e6))
    row += 1
    worksheet0.write(row,0,'CO2 Product from Pre-combustion Capture (kg/hr)')
    worksheet0.write(row,1,pyo.value(m.fs.co2_pre_separator.co2_outlet_state[0].flow_mol*m.fs.co2_pre_separator.co2_outlet_state[0].mole_frac_comp['CO2']*44*3.6))
    row += 1
    worksheet0.write(row,0,'CO2 Product from Post-combustion Capture (kg/hr)')
    worksheet0.write(row,1,pyo.value(m.fs.co2_post_separator.co2_outlet_state[0].flow_mol*m.fs.co2_post_separator.co2_outlet_state[0].mole_frac_comp['CO2']*44*3.6))
    row += 1
    worksheet0.write(row,0,'CO2 Mole Fraction in Flue Gas')
    worksheet0.write(row,1,pyo.value(m.fs.smr_shell.outlet.mole_frac_comp[0,'CO2']))
    row += 1
    worksheet0.write(row,0,'Flue Gas Flow Rate (kg/s)')
    worksheet0.write(row,1,pyo.value(m.fs.smr_shell.outlet.flow_mol[0]*m.fs.smr_shell.control_volume.properties_out[0].mw))
    row += 1
    worksheet0.write(row,0,'Natural Gas Feed Rate to SMR As Reactant (kg/hr)')
    worksheet0.write(row,1,pyo.value(m.fs.ng_preheat1.tube_inlet.flow_mol[0]*16.5143*3.6))
    row += 1
    worksheet0.write(row,0,'Natural Gas Feed Rate to SMR Furnace As Fuel (kg/hr)')
    worksheet0.write(row,1,pyo.value(m.fs.smr_shell_mix.fuel_inlet.flow_mol[0]*16.5143*3.6))
    row += 1
    worksheet0.write(row,0,'Reboiler Duty (MW)')
    worksheet0.write(row,1,pyo.value(m.fs.total_lp_duty_available[0]))
    row += 1
    worksheet0.write(row,0,'Required Reboiler Duty For Pre-Combustion Capture (MW)')
    worksheet0.write(row,1,pyo.value(m.fs.pre_capture_reboiler_duty[0]))
    row += 1
    worksheet0.write(row,0,'Required Reboiler Duty For Post-Combustion Capture (MW)')
    worksheet0.write(row,1,pyo.value(m.fs.post_capture_reboiler_duty[0]))

    # stream data
    worksheet1 = workbook.add_worksheet('stream_data')
    col = 0
    row = 0
    # list of streams
    syngas_list = []
    ...
    desc_list = []
    t = 0
    syngas_list.append(m.fs.ng_preheat1.tube.properties_in[t])
    desc_list.append('SMR Fuel Preheater Inlet')
    syngas_list.append(m.fs.smr_shell_mix.fuel_inlet_state[t])
    desc_list.append('SMR Furnace Fuel Inlet')
    syngas_list.append(m.fs.smr_shell_mix.tailgas_inlet_state[t])
    desc_list.append('Tail Gas Furnace Fuel Inlet')        
    syngas_list.append(m.fs.smr_shell_mix.air_inlet_state[t])
    desc_list.append('SMR Furnace Air Inlet')
    syngas_list.append(m.fs.smr_shell.control_volume.properties_out[t])
    desc_list.append('SMR Furnace Flue Gas Outlet')
    syngas_list.append(m.fs.smr_tube_mix.fuel_inlet_state[t])
    desc_list.append('SMR Fuel Reactant Inlet')
    syngas_list.append(m.fs.smr_tube_mix.steam_inlet_state[t])
    desc_list.append('SMR Steam Reactant Inlet')
    syngas_list.append(m.fs.smr_tube.control_volume.properties_out[t])
    desc_list.append('SMR Syngas Outlet')
    syngas_list.append(m.fs.syngas_cooler.shell.properties_out[t])
    desc_list.append('Syngas Cooler Syngas Outlet')
    syngas_list.append(m.fs.wgsr.control_volume.properties_out[t])
    desc_list.append('Water Gas Shift Reactor Syngas Outlet')
    syngas_list.append(m.fs.wgsr_cooler.shell.properties_out[t])
    desc_list.append('Shift Reactor Cooler Syngas Outlet')
    syngas_list.append(m.fs.lp_knockout_condenser.shell.properties_out[t])
    desc_list.append('LP Knockout Condenser Syngas Outlet')
    syngas_list.append(m.fs.mp_knockout_condenser.shell.properties_out[t])
    desc_list.append('MP Knockout Condenser Syngas Outlet')
    syngas_list.append(m.fs.cw_knockout_condenser.shell.properties_out[t])
    desc_list.append('Water Cooling Knockout Condenser Syngas Outlet')
    syngas_list.append(m.fs.co2_pre_separator.syngas_outlet_state[t])
    desc_list.append('Pre-combustion Capture Syngas Outlet')
    syngas_list.append(m.fs.co2_pre_separator.co2_outlet_state[t])
    desc_list.append('Pre-combustion Capture CO2 Outlet')
    syngas_list.append(m.fs.h2_separator.h2_outlet_state[t])
    desc_list.append('PSA H2 Outlet')
    syngas_list.append(m.fs.h2_comp.control_volume.properties_out[t])
    desc_list.append('H2 Compressor Outlet')
    syngas_list.append(m.fs.flue_gas_mp_cooler.shell.properties_out[t])
    desc_list.append('MP Heat Exchanger Flue Gas Outlet')
    syngas_list.append(m.fs.flue_gas_lp_cooler.shell.properties_out[t])
    desc_list.append('LP Heat Exchanger Flue Gas Outlet')
    syngas_list.append(m.fs.flue_gas_mp_econ.shell.properties_out[t])
    desc_list.append('MP Economizer Flue Gas Outlet')
    syngas_list.append(m.fs.co2_post_separator.co2_outlet_state[t])
    desc_list.append('Post-combustion Capture CO2 Outlet')
    syngas_list.append(m.fs.co2_mix.mixed_state[t])
    desc_list.append('Mixed Captured CO2 Outlet')
    syngas_list.append(m.fs.co2_pre_cool.control_volume.properties_out[t])
    desc_list.append('Precooled CO2 Outlet')

    water_list.append(m.fs.mp_pump.control_volume.properties_in[t])
    desc_list.append('MP Makeup Water Pump Inlet')
    water_list.append(m.fs.mp_pump.control_volume.properties_out[t])
    desc_list.append('MP Makeup Water Pump outlet')
    water_list.append(m.fs.lp_pump.control_volume.properties_in[t])
    desc_list.append('LP Pump Inlet')
    water_list.append(m.fs.cw_knockout_condenser.tube.properties_in[t])
    desc_list.append('Water Cooling Knockout Condenser Water Inlet')
    water_list.append(m.fs.cw_knockout_condenser.tube.properties_out[t])
    desc_list.append('Water Cooling Knockout Condenser Water Outlet')
    water_list.append(m.fs.mp_knockout_condenser.tube.properties_out[t])
    desc_list.append('MP Knockout Condenser Water Outlet')
    water_list.append(m.fs.lp_knockout_condenser.tube.properties_out[t])
    desc_list.append('LP Knockout Condenser Water Outlet')
    water_list.append(m.fs.mp_mix.mixed_state[t])
    desc_list.append('MP Water Mixer Outlet')
    water_list.append(m.fs.mp_booster_pump.control_volume.properties_out[t])
    desc_list.append('MP Booster Pump Water Outlet')
    water_list.append(m.fs.flue_gas_mp_econ.tube.properties_out[t])
    desc_list.append('MP Economizer Water Outlet')
    water_list.append(m.fs.flue_gas_mp_cooler.tube.properties_out[t])
    desc_list.append('MP Heat Exchanger Steam Outlet')
    water_list.append(m.fs.wgsr_cooler.tube.properties_out[t])
    desc_list.append('LP Shift Reactor Cooler Water Outlet')
    water_list.append(m.fs.syngas_cooler.tube.properties_out[t])
    desc_list.append('LP Syngas Cooler Water Outlet')
    water_list.append(m.fs.flue_gas_lp_cooler.tube.properties_out[t])
    desc_list.append('LP Heat Exchanger Steam Outlet')

    co2_list.append(m.fs.co2_comp1.control_volume.properties_in[t])
    desc_list.append('CO2 Compressor 1 Inlet')
    co2_list.append(m.fs.co2_comp8.control_volume.properties_out[t])
    desc_list.append('CO2 Compressor 8 Outlet')        

    nstream = len(syngas_list) + len(water_list) + len(co2_list)
    # write the stream number
    worksheet1.write(row,col,'Stream ID')
    for i in range(nstream):
        col += 1
        worksheet1.write(row,col,i+1)
    # write stream description
    unity = 1
    row += 1
    col = 0
    worksheet1.write(row,col,'Stream Description')
    for desc in desc_list:
        col += 1
        worksheet1.write(row,col,desc)
    # write the species name based on syn_props
    row += 1
    col = 0
    worksheet1.write(row,col,'Species Mole Fraction')
    for comp in m.fs.syn_props.component_list:
        row += 1
        col = 0
        worksheet1.write(row,col,comp)
        for stream in syngas_list:
            col += 1
            worksheet1.write(row,col,pyo.value(stream.mole_frac_comp[comp]))
        for stream in water_list:
            col += 1
            if (comp=='H2O'):
                worksheet1.write(row,col,unity)
        for stream in co2_list:
            col += 1
            if (comp=='CO2'):
                worksheet1.write(row,col,unity)                
    row += 1
    col = 0
    worksheet1.write(row,col,'Molecular Weight (kg/mol)')
    for stream in syngas_list:
        col += 1
        worksheet1.write(row,col,pyo.value(stream.mw))
    for stream in water_list:
        col += 1
        worksheet1.write(row,col,pyo.value(stream.mw))
    for stream in co2_list:
    ...
    row += 1
    col = 0
    worksheet1.write(row,col,'Molar Flow rate (mol/s)')
    for stream in syngas_list:
        col += 1
        worksheet1.write(row,col,pyo.value(stream.flow_mol))
    for stream in water_list:
        col += 1
        worksheet1.write(row,col,pyo.value(stream.flow_mol))
    for stream in co2_list:
    ...
    row += 1
    col = 0
    worksheet1.write(row,col,'Pressure (Pa)')
    for stream in syngas_list:
        col += 1
        worksheet1.write(row,col,pyo.value(stream.pressure))
    for stream in water_list:
        col += 1
        worksheet1.write(row,col,pyo.value(stream.pressure))
    for stream in co2_list:
    ...
    row += 1
    col = 0
    worksheet1.write(row,col,'Temperature (K)')
    for stream in syngas_list:
        col += 1
        worksheet1.write(row,col,pyo.value(stream.temperature))
    for stream in water_list:
        col += 1
        worksheet1.write(row,col,pyo.value(stream.temperature))
    for stream in co2_list:
    ...
    row += 1
    col = 0
    worksheet1.write(row,col,'Molar Enthalpy (J/mol)')
    for stream in syngas_list:
        col += 1
        worksheet1.write(row,col,pyo.value(stream.enth_mol))
    for stream in water_list:
        col += 1
        worksheet1.write(row,col,pyo.value(stream.enth_mol))
    for stream in co2_list:
    ...
    row += 1
    col = 0
    worksheet1.write(row,col,'Vapor Fraction')
    for stream in syngas_list:
        col += 1
        worksheet1.write(row,col,unity)
    for stream in water_list:
        col += 1
        worksheet1.write(row,col,pyo.value(stream.vapor_frac))
    for stream in co2_list:
        col += 1
        worksheet1.write(row,col,pyo.value(stream.vapor_frac))
    workbook.close()

def get_blue_hydrogen_plant_model_from_json():
    m = pyo.ConcreteModel(name='TTNEP plant')
    ...
    init_fname = 'smr_only_baseline.json'
    if os.path.exists(init_fname):
        ...
        write_results_to_excel(m, 'smr_only_baseline.xlsx')
    return m
...
def get_blue_hydrogen_plant_model():
    ...
    #m.fs.lp_pump.inlet.flow_mol.unfix()
    dof = degrees_of_freedom(m)
    print('dof=', dof)
    solver.solve(m, tee=True)
    ...
    solver.solve(m, tee=True)
    ms.to_json(m, fname='smr_only_baseline.json')
    write_results_to_excel(m, 'smr_only_baseline.xlsx')
    print('H2 production rate kg/hr', pyo.value(m.fs.h2_separator.h2_outlet_state[0].flow_mol*m.fs.h2_separator.h2_outlet_state[0].mw)*3600)
    print('pre_reboiler_duty=', pyo.value(m.fs.pre_capture_reboiler_duty[0]))
    print('post_reboiler_duty=', pyo.value(m.fs.post_capture_reboiler_duty[0]))
    print('lp_heat_available=', pyo.value(m.fs.total_lp_duty_available[0]))
    print('co2 product from post-combustion capture kg/hr=',pyo.value(m.fs.smr_shell.outlet.flow_mol[0]*m.fs.smr_shell.outlet.mole_frac_comp[0,'CO2']*0.97*44*3.6))
    print('co2 product from pre-combustion capture kg/hr=',pyo.value(m.fs.co2_pre_separator.co2_outlet_state[0].flow_mol*m.fs.co2_pre_separator.co2_outlet_state[0].mole_frac_comp['CO2']*44*3.6))
    print('smr furnace ng feed rate kg/hr=',pyo.value(m.fs.smr_shell_mix.fuel_inlet.flow_mol[0]*16.5143*3.6))
    print('smr reactant ng feed rate kg/hr=',pyo.value(m.fs.ng_preheat1.tube_inlet.flow_mol[0]*16.5143*3.6))
    print('flue gas flow rate kg/s=',pyo.value(m.fs.smr_shell.outlet.flow_mol[0]*m.fs.smr_shell.control_volume.properties_out[0].mw))
    print('co2 mole pct in flue gas=',pyo.value(m.fs.smr_shell.outlet.mole_frac_comp[0,'CO2']*100))
    return m


if __name__ == "__main__":
    m = get_blue_hydrogen_plant_model()
    #m = get_blue_hydrogen_plant_model_from_json()
