...
see property package for documentation.}"""))
    ...
    def build(self):
        ...
        self.tube_cv = ControlVolume0DBlock(
        ...
        self.shell_cv = ControlVolume0DBlock(
                dynamic=self.config.dynamic,
                has_holdup=self.config.has_holdup,
    ...
    def _make_performance(self):
        ...
        def heat_flux_tube_eqn(b, t):
            return b.heat_flux_tube[t] == b.hconv_tube[t] * (b.temp_tube_inner[t] \
                   ...
                   +  b.tube_cv.properties_out[t].temperature_sat)/2 )
    ...
    def initialize_build(blk, state_args_tube=None, state_args_shell=None,
        ...
        blk.hpool_eqn.deactivate()
        blk.enhancement_factor_eqn.deactivate()
        blk.hpool.fix()
        ...
        blk.hpool_eqn.activate()
        blk.enhancement_factor_eqn.activate()
        blk.hpool.unfix()
